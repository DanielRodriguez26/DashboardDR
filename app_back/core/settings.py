...
SECRET_KEY = 'django-insecure-7!$_xkkj@7*@5tvx$fx%&g8qz4!gp!1hy_(#!$u1u$01i(rzh)'
...
ECOMMERCE_APPS = ['apps.category', 'apps.todo']
THIRD_PARTY_APPS = [
    'corsheaders',
    'rest_framework',
    'djoser',
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, '../app-front/build')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
